      ...
      <section className="workspace">
        <aside className="panel import-panel">
          ...
          <div className="project-links">
            <a className="support-project" href="https://pay.cloudtips.ru/p/55cf592d" target="_blank" rel="noreferrer"><span>♡</span><strong>{t("Support the project")}</strong><span>↗</span></a>
