...
type PostEffect = "None" | "Cartoon" | "Sketch" | "Halftone" | "Pixelate" | "Chromatic" | "Duotone" | "Dither" | "Glow";
...
const ru:Record<string,string>={
  ...
  "Text becomes real editable 3D outlines, including counters inside letters.":"Текст преобразуется в редактируемые 3D-контуры, включая полости внутри букв.","Transparent shapes with clean edges give the best extrusion.":"Прозрачные фигуры с чистыми краями дают лучший результат экструзии.","Support the project":"Поддержать проект",
      ...
      <section className="workspace">
        <aside className="panel import-panel">
          ...
          <div className="project-links">
            <a className="support-project" href="https://pay.cloudtips.ru/p/55cf592d" target="_blank" rel="noreferrer"><svg className="support-icon" viewBox="0 0 16 16" aria-hidden="true"><path d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314"/></svg><strong>{t("Support the project")}</strong><span>↗</span></a>
